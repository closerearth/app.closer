    ...
    <Layout>
      ...
      <main className="flex flex-col justify-between p-6">
        ...
        <div className='flex flex-col items-start md:w-full'>
            ...
            <div>
              <img src={`${cdn}${member.photo}-profile-sm.jpg`} loading="lazy" alt="this is an image" className="w-22 md:w-34 mt-4 rounded-full cursor-pointer transition duration-150 transform hover:scale-110" />
            </div>
            <div >
