    ...
    <Layout protect>
      ...
      <div className="main-content">
        ...
        { !config.STRIPE_PUB_KEY &&
          <div className="p2 italic">This platform doesnt have a global Stripe integration. If you wish to set paid tickets for your event you must define a custom Stripe integration in the tickets tab below.</div>
        }
        <EditModel
          id={ event._id }
          endpoint="/event"
